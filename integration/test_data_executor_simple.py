...
def test_fetch_rss():
    ...
    with DataExecutor() as executor:
        # 测试路径：B站UP主视频（示例）
        # 也可以测试：/hupu/bbs/bxj/1 (虎扑步行街)
        #          /weibo/user/1195230310 (微博热搜)
...
def test_from_config():
    ...
    from integration.data_executor import create_data_executor_from_config
