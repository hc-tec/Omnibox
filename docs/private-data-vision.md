  ...
  bilibili_favorites (id, bvid, title, cover, collected_at, folder_name, view_count,
  user_id)
  ...
  - 用户主动触发："刷新我的GitHub数据"
  - 查询驱动同步：用户问"我最近star了哪些仓库" → 检查上次同步时间 →
  如果超过6小时，先同步再回答
  ...
  复制Notion/Obsidian的笔记功能（已有成熟产品）❌ 做成"个人搜索引擎"（Google已经够好）
